#!/usr/bin/env python3
"""
Test script for the BGE-based RAG retriever
"""
...
def main():
    print("Testing BGE-based RAG retriever...")
    ...
    try:
        # Try to import the BGE retriever
        try:
            from rag.bge_retriever import BGERetriever, get_relevant_legal_context, DEPENDENCIES_AVAILABLE
            
            if not DEPENDENCIES_AVAILABLE:
                print("Error: Required dependencies not available")
                return
        except ImportError as e:
            print(f"Error importing BGE retriever: {str(e)}")
            return
        
        # Initialize the retriever
        print("Initializing BGE retriever...")
        retriever = BGERetriever(vector_db_dir)
        ...
        print("\nBGE-based RAG retriever test completed successfully!")
        
    except Exception as e:
        print(f"Error testing BGE-based RAG retriever: {str(e)}")
        traceback.print_exc()
